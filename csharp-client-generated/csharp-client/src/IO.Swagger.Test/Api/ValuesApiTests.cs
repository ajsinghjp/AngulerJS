...
namespace IO.Swagger.Test
{
    ...
    public class ValuesApiTests
    {
        ...
        /// <summary>
        /// Test ValuesGetEveryThing
        /// </summary>
        [Test]
        public void ValuesGetEveryThingTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.ValuesGetEveryThing();
            //Assert.IsInstanceOf<List<string>> (response, "response is List<string>");
        }
        
        /// <summary>
        /// Test ValuesGetOneThing
        /// </summary>
        [Test]
        public void ValuesGetOneThingTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? id = null;
            //var response = instance.ValuesGetOneThing(id);
